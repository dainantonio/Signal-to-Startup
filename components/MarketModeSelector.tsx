    ...
    <div className="flex flex-wrap gap-2">
      {(Object.values(marketModeConfigs) as MarketModeConfig[]).map((config) => (
        <button
          ...
          className={`flex items-center gap-2 px-3 py-1.5 rounded-full border-2 border-[#141414] font-mono text-[10px] uppercase tracking-wider transition-all shadow-[2px_2px_0px_0px_rgba(20,20,20,1)] active:shadow-none active:translate-x-[1px] active:translate-y-[1px] ${
